    ...
    return (
        <div className="grid justify-center gap-2">
            ...
            <div className="bg-[#242452] border-8 border-[#0F0D2D] rounded-[25px] grid justify-center gap-2 px-[10vw] py-5">
                ...
                <Link to="/dashboard"
                    className="text-sm text-white bg-blue-700 rounded-[20px] hover:bg-blue-800 focus:ring-2 focus:ring-[#9690C4] dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 p-2">Continue
                </Link>
                <p className="text-xs text-white pb-10">Don't have an account? <Link to="/signup" className="text-[#FE9324]">Sign up</Link></p>
            </div>
        </div>
    )
}